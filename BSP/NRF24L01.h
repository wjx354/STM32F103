...
while(1)
	{
		...
		if( 0 != j )
		{
			OLED_ShowString(0,7,RF24L01RxBuffer,16,1);//清空第二屏幕显示
			OLED_Refresh();
			delay_ms(500);
			OLED_Clear();

			printf(RF24L01RxBuffer);
			memset(RF24L01RxBuffer,0,sizeof(RF24L01RxBuffer));
		}
